...
map_case=folium.Map(location=[37.508163,126.884387],zoom_start=10,tiles="Cartodb Positron")
group19=folium.FeatureGroup(name='<span style = " font-size:0.7em;">%s</span> '% ('city'))
folium.Choropleth(
    geo_data=ko_states,
    key_on="properties.name_eng",topojson="objects.skorea_municipalities_2018_geo",fill_opacity=0.0,
...
map_case=folium.Map(location=[35.84008,128.8],zoom_start=8,tiles="Cartodb Positron")
group19=folium.FeatureGroup(name='<span style = " font-size:0.7em;">%s</span> '% ('city'))
folium.Choropleth(
    geo_data=ko_states,
    key_on="properties.name_eng",topojson="objects.skorea_municipalities_2018_geo",fill_opacity=0.0,
